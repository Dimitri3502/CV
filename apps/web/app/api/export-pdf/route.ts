...
import {CV_PDF_FILENAME_PREFIX, DEFAULT_LOCALE, isSupportedLocale, type Locale} from '@cv/common';
...
function resolveLocale(rawLocale: string | null): Locale {
  ...
  try {
    ...
    return new NextResponse(pdfBlob, {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="${CV_PDF_FILENAME_PREFIX}-${locale}.pdf"`,
