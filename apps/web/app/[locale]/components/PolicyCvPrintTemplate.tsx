...
type PolicyCvPrintTemplateProps = {
  data: PolicyCvData;
};
...
export function PolicyCvPrintTemplate({data}: PolicyCvPrintTemplateProps) {
  ...
  return (
    <div
      ...
      className="cv-root is-print-mode min-h-screen py-0"
    >
      <div className="cv-sheet policy-cv-print-sheet bg-white">
        <aside className="cv-sidebar policy-cv-sidebar bg-[var(--color-bg-dark)] p-4 text-[var(--color-text-light)] sm:p-[30px]">
          {renderSidebarContent()}
        </aside>

        <main className="cv-main policy-cv-main policy-cv-print-flow overflow-wrap-anywhere p-8 max-[600px]:p-4 max-[600px]:pr-3 sm:pr-6">
          {renderMainHeader()}
          {renderFirstPageSections()}
        </main>
      </div>

      <section className="policy-cv-print-follow-up overflow-wrap-anywhere px-8 max-[600px]:px-4 max-[600px]:pr-3 sm:pr-6">
